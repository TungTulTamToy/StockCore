...
namespace StockCore.Business.Operation.SyncFromWeb
{
    public class SyncQuote:IOperation<string>
    {
        ...
        private async Task<Tuple<IEnumerable<PriceDE>,IEnumerable<SetIndexDE>,IEnumerable<Consensus>,IEnumerable<ShareDE>,IEnumerable<StatisticDE>>> readFromWeb(string quote)
        {
            ...
            return new Tuple<IEnumerable<PriceDE>,IEnumerable<SetIndexDE>,IEnumerable<Consensus>,IEnumerable<ShareDE>,IEnumerable<StatisticDE>>(price, setIndex,consensus,share,statistic);
        }
        private async Task<Tuple<IEnumerable<PriceDE>,IEnumerable<SetIndexDE>,IEnumerable<Consensus>,IEnumerable<ShareDE>,IEnumerable<StatisticDE>>> readFromDB(string quote)
        {
        ...
        private Tuple<IEnumerable<PriceDE>,IEnumerable<SetIndexDE>,IEnumerable<Consensus>,IEnumerable<ShareDE>,IEnumerable<StatisticDE>> calculateTupleToInsert(
            Tuple<IEnumerable<PriceDE>,IEnumerable<SetIndexDE>,IEnumerable<Consensus>,IEnumerable<ShareDE>,IEnumerable<StatisticDE>> webTuple, 
            Tuple<IEnumerable<PriceDE>,IEnumerable<SetIndexDE>,IEnumerable<Consensus>,IEnumerable<ShareDE>,IEnumerable<StatisticDE>> dbTuple)
        {
            ...
            return new Tuple<IEnumerable<PriceDE>,IEnumerable<SetIndexDE>,IEnumerable<Consensus>,IEnumerable<ShareDE>,IEnumerable<StatisticDE>>(priceToInsert, setIndexToInsert,consensusToInsert,shareToInsert,statisticToInsert);
        }
